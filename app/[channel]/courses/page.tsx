...
import CourseCollectionCard from "@/components/VideoCard/CourseCollectionCard";

export default function ChannelCoursesPage() {
        ...
        <div className="flex-1 ml-60 overflow-y-auto">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 py-6">
            ...
            <nav className="sticky top-0 z-20 flex items-center gap-1 text-[16px] overflow-x-auto  bg-[#0f0f0f]/80 backdrop-blur-lg px-3 py-1 ">
              ...
              <button className="flex items-center gap-2 px-4 py-2  text-neutral-300 border-b-2 border-transparent hover:border-[#717171]">
                {/* <Film size={16} /> */}
                Videos
              </button>
              <Link
              ...
              <Link
                ...
                className="flex items-center gap-2 px-4 py-2  text-white border-white border-b-2   "
              >
                {/* <PlaySquare size={16} /> */}
                Courses
              </Link>
